...
async function submitForm(e){
  ...
  try{
    ...
    toast('Registo submetido com sucesso.'); resetForm(); loadStats(); loadAppData();
...
// v49 — Dropdown Igreja das Contribuições corrigido; grupos e igrejas sincronizados
...
async function loadAvanteData(){
  ...
  // v49: primeiro preenche a página com dados locais do ficheiro de metas.

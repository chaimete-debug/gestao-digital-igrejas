...
// mas nada é gravado no Google Sheets.
// ─────────────────────────────────────────────────────────────
const SANDBOX_MODE = (() => {
...
function setupSandboxBanner(){
  ...
  banner.innerHTML = '<strong>Modo teste</strong> — pode preencher, submeter e explorar. Nenhum dado será gravado no Google Sheets.';
...
async function submitForm(e){
  ...
  try{
    ...
    if(SANDBOX_MODE){
      ...
      toast('Modo teste: registo simulado. Nada foi gravado no Google Sheets.');
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try{
      ...
      if(SANDBOX_MODE){
        ...
        toast('Modo teste: certificação simulada. Nada foi gravado no Google Sheets.');

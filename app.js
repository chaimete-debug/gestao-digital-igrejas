...
// v54.4.0: mantém a autenticação por separador e aplica escopo de leitura por igreja. Ao fechar o
...
async function setSelectedWorkChurch(id){
  ...
  // v54.4.0: a alteração da igreja actualiza imediatamente todas as
...
// v54.4.0 — isolamento por igreja, escopo distrital/local e permissões reforçadas.

...
// v42 — Avante Evangelho 2026 + correcção consolidada dos ITs no backend
...
async function loadAvanteData(){
  ...
  try{
    ...
    if(!avanteState.groups.length){
      if(body) body.innerHTML='<tr><td colspan="7">Não há grupos carregados. Execute a função setup() ou repararAvanteEvangelho2026() no Apps Script e publique novamente o backend.</td></tr>';
      $('#avanteKpis').innerHTML='<div class="avante-empty">Não há grupos carregados. Verifique as folhas Avante_Grupos e Avante_Igrejas.</div>';

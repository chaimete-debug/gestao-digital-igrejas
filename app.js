...
// v54.4.1: mantém a autenticação por separador e aplica escopo de leitura por igreja. Ao fechar o
...
async function setSelectedWorkChurch(id){
  ...
  // v54.4.1: a alteração da igreja actualiza imediatamente todas as
...
function openView(viewId){
  ...
  if(viewId === 'helpView') loadUsersAdmin();
...
// v54.4.1 — isolamento por igreja, escopo distrital/local e permissões reforçadas.

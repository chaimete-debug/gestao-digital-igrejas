...
// v54.4.2: mantém a autenticação por separador e aplica escopo de leitura por igreja. Ao fechar o
...
async function setSelectedWorkChurch(id){
  ...
  // v54.4.2: a alteração da igreja actualiza imediatamente todas as
...
// v54.4.2 — isolamento por igreja, escopo distrital/local e permissões reforçadas.

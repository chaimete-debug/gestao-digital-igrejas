...
// v45 — Consolidação: dados do app + Avante + ITs; anti-cache
...
async function loadAvanteData(){
  ...
  try{
    let out=null;
    const normalizar=(data)=>({ok:!!(data&&data.ok),groups:(data&&Array.isArray(data.groups))?data.groups:[]});
